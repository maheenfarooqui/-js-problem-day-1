...
// and this is fast method
let num8a = 30;
let multiply = 15;
for (let i = multiply; i <= num8a; i += multiply) {
  console.log(i);
}
...
console.log(sum9);
// best approach least time
let num9a = 3;
let numbers9a = Math.ceil(num9a / 2);
let sum9a = numbers9a * numbers9a;
console.log(sum9a);
